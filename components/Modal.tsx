            ...
            >
                <div className='flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
                    <Transition.Child
                        ...
                        leaveTo='opacity-0'
                    >
                        <Dialog.Overlay className='fixed inset-0 bg-gray-500 bg-opacity-75 transtion-opacity' />

                    </Transition.Child>
                    {/* This element is to trick to browser into centering the modal contents */}
                    <span
                    ...
                    >
                        <div className='inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full'>
                            <div>
                                <div className='mx-auto flex items-center justify-center h-12 w-12 bg-red-100 cursor-pointer rounded-full'>
                                    <CameraIcon
